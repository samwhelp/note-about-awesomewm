...
base_var_init () {
	...
	THE_SELF_UPDATE_URL='https://raw.githubusercontent.com/samwhelp/note-about-awesomewm/gh-pages/_demo/project/awesomewmrc-profile/awesomewmrc-get/awesomewmrc-get'
