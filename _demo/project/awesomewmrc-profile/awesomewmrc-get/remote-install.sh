...
# * https://github.com/samwhelp/note-about-awesome-wm/blob/gh-pages/_demo/project/awesomewmrc-profile/awesomewmrc-get/remote-install.sh
...
# * https://raw.githubusercontent.com/samwhelp/note-about-awesome-wm/gh-pages/_demo/project/awesomewmrc-profile/awesomewmrc-get/awesomewmrc-get
...
## $ export DEBUG_AWESOMEWMRC_GET_INSTALL=true
is_debug () {
	if [ "$DEBUG_AWESOMEWMRC_GET_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="awesomewmrc-get-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-awesome-wm/blob/gh-pages/_demo/project/awesomewmrc-profile/awesomewmrc-get/awesomewmrc-get
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-awesome-wm/gh-pages/_demo/project/awesomewmrc-profile/awesomewmrc-get/awesomewmrc-get'


	THE_TARGET_FILE_NAME="awesomewmrc-get"
